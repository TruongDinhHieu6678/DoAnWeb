                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="{{URL::to('/Cart-page')}}">Giỏ hàng</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            ...
                            <li><a href="{{URL::to('/Cart-page')}}"><i class="fa fa-shopping-cart"></i> Giỏ hàng</a></li>
                            ...
                            if ($acc != null || $id_u != null){
                                ...
                                ?>
                                <li><a href="{{URL::to('/Login-page')}}"><i class="fa fa-lock"></i> Đăng xuất</a></li>
                                <?php
                            }else{
                                ?>
