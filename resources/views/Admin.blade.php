...
<head>
	...
	<link href="{{('public/frondend/css/style-responsive.css')}}" rel="stylesheet"/>
	<!-- font CSS -->
	...
	<link rel="stylesheet" href="{{('public/frondend/css/morris.css')}}" type="text/css"/>
	<!-- calendar -->
	<link rel="stylesheet" href="{{('public/frondend/css/monthly.css')}}">
	<!-- //calendar -->
	<!-- //font-awesome icons -->
	<script src="{{('public/frondend/js/jquery2.0.3.min.js')}}"></script>
	<script src="{{('public/frondend/js/raphael-min.js')}}"></script>
	<script src="{{('public/frondend/js/morris.js')}}"></script>
</head>
<body>
			...
			<div id="sidebar" class="nav-collapse">
				...
				<div class="leftside-navigation">
					<ul class="sidebar-menu" id="nav-accordion">
						<li>
							<a class="active" href="{{URL::to('/Admin')}}"><!--đường dẫn đến page login-->
...
<!-- calendar -->
<script type="text/javascript" src="{{('public/frondend/js/monthly.js')}}"></script>
